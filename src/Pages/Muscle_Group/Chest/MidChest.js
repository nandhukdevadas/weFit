  ...
  return (
    ...
    <div className='workout-list-shoulder-front-delts'>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Barbell Bench Press</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Pec Deck Machine</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Pinch Press</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Incline Cable Flys</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
