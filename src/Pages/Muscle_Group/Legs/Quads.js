...
import image3 from '../../../Images/quads-transparent.png';
...
const Shoulder = () => {
  ...
  return (
    ...
    {/* Back Symbol */}
      ...
      <Link to='/muscleGroupLegsGroup'> <span className='general-instructions-drop-down'><UilArrowCircleLeft size="30" color="#000" /></span></Link>
      </div> */}
    ...
    <div className='general-instructions-title'>
        ...
        <span className='general-instructions-drop-down' ><UilArrowDown size="25" color="#248A3D" /></span>
    </div>
    ...
    <div className='workout-list-shoulder-front-delts'>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Barbell Squats</Link>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Split Squats</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Leg Extension</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
