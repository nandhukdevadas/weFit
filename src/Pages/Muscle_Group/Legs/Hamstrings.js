...
import image3 from '../../../Images/hamstrings-transparent.png';
import video1 from '../../../Images/legs/hamstring-curls.mp4';
import video2 from '../../../Images/legs/sumo-squats.mp4';
    ...
    <div className='workout-list-shoulder-front-delts'>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Hamstrings curls</Link>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Sumo squats</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
