    ...
    <div className='workout-list-shoulder-front-delts'>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Seated Concentration Curls</Link>
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Cable Curls</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Chin Ups</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Preacher Curls</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
        ...
        <div className='workout-card-latest'>
            ...
            <div className='workout-card-latest-name'>
                <Link to='/muscleGroupFrontDeltoid'>Barbell Curls</Link>
                <div className='workout-card-latest-youtube-icon'>
                    <a href='https://www.youtube.com/shorts/bQPhGIJJ-jQ' ><FaYoutube /></a>
                </div> 
            </div> 
